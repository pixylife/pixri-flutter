      ...
      body: SafeArea(
        child: Container(
          child: RefreshIndicator(
            onRefresh: () =>
                apiService.getListOfEntityByApplication(widget.application.id),
            child: FutureBuilder(
              future: apiService
                  .getListOfEntityByApplication(widget.application.id),
              builder:
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          _entity.description != null &&
                                  _entity.description.isNotEmpty
                              ? Container(
                                  padding: const EdgeInsets.all(8),
